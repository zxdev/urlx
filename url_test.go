...
func TestURL(t *testing.T) {
	...
	/*
		=== RUN   TestURL
		    ...
		    url_test.go:97: flags     apex= false ip= false idna= false kind= 0
		    ...
		    url_test.go:97: flags     apex= true ip= false idna= true kind= 1
		    ...
		    url_test.go:97: flags     apex= true ip= false idna= false kind= 1
		    ...
		    url_test.go:97: flags     apex= false ip= false idna= false kind= 1
		    ...
		    url_test.go:97: flags     apex= true ip= false idna= false kind= 2
		    ...
		    url_test.go:97: flags     apex= false ip= true idna= false kind= 0
	...
	*/
	...
	for _, v := range []string{
		...
		t.Log("flags     apex=", u.HostIsApex(), "ip=", u.IP, "idna=", u.IDNA, "kind=", u.Kind)
